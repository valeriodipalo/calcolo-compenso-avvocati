    ...
    clusters: [
      {
        ...
        tools: [
          ...
          { label: "Fattura elettronica avvocati", slug: "fattura-elettronica-avvocati", badge: "Nuovo" },
    ...
    clusters: [
      {
        ...
        tools: [
          ...
          { label: "Calcolo IRPEF", slug: "calcolo-irpef", badge: "Nuovo" },
    ...
    clusters: [
      {
        ...
        tools: [
          { label: "Calcolo percentuale", slug: "calcolo-percentuale", badge: "Nuovo" },
          { label: "Giorni tra date", slug: "calcolo-giorni-tra-date" },
