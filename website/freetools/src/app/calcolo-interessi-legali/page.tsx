    ...
    <ToolLayout config={toolConfig}>
      ...
      <div className="space-y-4">
        <p className="text-base leading-relaxed">
          Il <strong>tasso di interesse legale 2026</strong> &egrave; pari all&apos;<strong className="font-mono">1,60%</strong> in ragione d&apos;anno, come stabilito dal <InlineNormLink text="Decreto del Ministero dell&apos;Economia e delle Finanze del 10 dicembre 2025" url="https://www.gazzettaufficiale.it/eli/id/2025/12/13/25A06705/sg" />, pubblicato sulla Gazzetta Ufficiale n. 289 del 13 dicembre 2025. Il nuovo tasso &egrave; in vigore dal <strong>1&deg; gennaio 2026</strong>.
        </p>
        ...
        <NormativaQuote url="https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:regio.decreto:1942-03-16;262~art1284">
          Art. 1284, c. 1, cod. civ.: &quot;Il saggio degli interessi legali &egrave; determinato in misura pari al 5 per cento in ragione d&apos;anno. Il Ministro del tesoro, con proprio decreto pubblicato nella Gazzetta Ufficiale della Repubblica italiana non oltre il 15 dicembre dell&apos;anno precedente a quello cui il saggio si riferisce, pu&ograve; modificarne annualmente la misura [...]&quot;
        </NormativaQuote>
        <p className="text-base leading-relaxed">
          La facolt&agrave; di aggiornamento annuale del tasso &egrave; stata introdotta dalla <InlineNormLink text="L. 23 dicembre 1996, n. 662" url="https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:legge:1996-12-23;662" /> (art. 2, comma 185), che ha novellato l&apos;<InlineNormLink text="art. 1284 del Codice Civile" url="https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:regio.decreto:1942-03-16;262~art1284" />.
        </p>
      </div>
      ...
      <p className="text-base leading-relaxed mb-4">
        La <strong>tabella dei tassi di interesse legale</strong> riporta lo storico completo dal 1942 ad oggi. Il tasso originario del 5% &egrave; rimasto invariato per quasi 50 anni, fino alla prima modifica nel 1990. Dal 1997 il tasso viene aggiornato annualmente dal MEF.
      </p>
      <LegalTable
      ...
      <p className="text-sm text-muted-foreground mt-3">
        Il tasso pi&ugrave; basso della storia &egrave; stato lo <strong className="font-mono">0,01%</strong> nel 2021, mentre il pi&ugrave; alto &egrave; stato il <strong className="font-mono">10%</strong> nel periodo 1990-1996.
      </p>
      ...
      <div className="space-y-4">
        <p className="text-base leading-relaxed">
          La formula per il <strong>calcolo degli interessi legali</strong> a interesse semplice &egrave;:
        </p>
        <div className="bg-[oklch(0.97_0.005_250)] border border-[oklch(0.90_0.02_250)] p-5 text-center" style={{ borderRadius: "0.375rem" }}>
          <p className="text-xl font-mono font-bold text-[oklch(0.25_0.04_250)]">
            I = C &times; S &times; N / 36.500
          </p>
          <p className="text-sm text-muted-foreground mt-2">
            I = interessi &bull; C = capitale &bull; S = tasso % annuo &bull; N = giorni
          </p>
        </div>
        <p className="text-base leading-relaxed">
          Il divisore <strong className="font-mono">36.500</strong> (365 &times; 100) resta invariato anche negli <strong>anni bisestili</strong>, come confermato dalla <a href="https://www.agenziaentrate.gov.it/portale/documents/20143/0/Risoluzione_14_07_2008_296.pdf" target="_blank" rel="noopener noreferrer" className="text-[oklch(0.45_0.12_250)] underline decoration-dotted underline-offset-2 hover:text-[oklch(0.35_0.15_250)]">Risoluzione dell&apos;Agenzia delle Entrate n. 296/E del 14 luglio 2008</a>.
        </p>
        <AlertBox variant="info" title="Periodi con tassi diversi">
          <p className="leading-relaxed">
            Quando il periodo di calcolo attraversa pi&ugrave; anni con tassi diversi, occorre <strong>suddividere</strong> il calcolo in sotto-periodi corrispondenti a ciascun tasso vigente. Per ogni sotto-periodo si applica la formula con il tasso del periodo. Il totale &egrave; la somma degli interessi di ciascun sotto-periodo.
          </p>
        </AlertBox>
        <h3 className="text-xl text-[oklch(0.25_0.04_250)] mt-4 mb-3">Esempio pratico</h3>
        <p className="text-base leading-relaxed">
          Calcolo degli interessi su <strong className="font-mono">&euro; 10.000,00</strong> dal 1&deg; luglio 2025 al 30 giugno 2026:
        </p>
        <LegalTable
      ...
      <div className="space-y-4">
        ...
        <AlertBox variant="warning" title="Interessi in corso di causa">
          <p className="leading-relaxed">
            Dal 2014 (<InlineNormLink text="D.L. 132/2014, art. 17" url="https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:decreto.legge:2014-09-12;132" />), il comma 4 dell&apos;art. 1284 c.c. prevede che, se le parti non hanno pattuito la misura degli interessi moratori, dal momento della <strong>domanda giudiziale</strong> il saggio degli interessi &egrave; pari a quello delle transazioni commerciali (tasso BCE + 8 pp). Questa disposizione si applica automaticamente e costituisce un forte incentivo alla definizione stragiudiziale delle controversie.
          </p>
        </AlertBox>
      </div>
